...
/**
 * This class stands for identificationType EnumType
 * @subpackage Enumerations
 */
class IdentificationType
{
    /**
     * Constant for value 'actDbId'
     * @return string 'actDbId'
     */
    const VALUE_ACT_DB_ID = 'actDbId';
    /**
