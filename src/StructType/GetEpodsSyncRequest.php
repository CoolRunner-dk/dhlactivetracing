...
class GetEpodsSyncRequest extends AbstractStructBase
{
     ...
     * @return \DHLTracking\StructType\ConsignmentIdentificationType[]
     */
     ...
     * @param \DHLTracking\StructType\ConsignmentIdentificationType[] $consignmentIdentification
     * @return \DHLTracking\StructType\GetEpodsSyncRequest
     */
    public function setConsignmentIdentification(array $consignmentIdentification = array())
    {
        foreach ($consignmentIdentification as $getEpodsSyncRequestConsignmentIdentificationItem) {
            ...
            if (!$getEpodsSyncRequestConsignmentIdentificationItem instanceof \DHLTracking\StructType\ConsignmentIdentificationType) {
                throw new \InvalidArgumentException(sprintf('The consignmentIdentification property can only contain items of \DHLTracking\StructType\ConsignmentIdentificationType, "%s" given', is_object($getEpodsSyncRequestConsignmentIdentificationItem) ? get_class($getEpodsSyncRequestConsignmentIdentificationItem) : gettype($getEpodsSyncRequestConsignmentIdentificationItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \DHLTracking\StructType\ConsignmentIdentificationType $item
     * @return \DHLTracking\StructType\GetEpodsSyncRequest
     */
    public function addToConsignmentIdentification(\DHLTracking\StructType\ConsignmentIdentificationType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \DHLTracking\StructType\ConsignmentIdentificationType) {
            throw new \InvalidArgumentException(sprintf('The consignmentIdentification property can only contain items of \DHLTracking\StructType\ConsignmentIdentificationType, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
