...
class GetConsignmentDetailsRequest extends AbstractStructBase
{
     ...
     */
    public function __construct($actDbId = null, $actUserId = null, $responseLocale = null, \DHLTracking\StructType\DateRangeType $updateDateRange = null, $showAddressData = null)
    {
        $this
            ->setActDbId($actDbId)
     ...
     * Set actDbId value
     * @param int $actDbId
     * @return \DHLTracking\StructType\GetConsignmentDetailsRequest
     */
