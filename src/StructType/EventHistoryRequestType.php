...
class EventHistoryRequestType extends AbstractStructBase
{
     ...
     * @param \StructType\DateRangeType $eventDateRange
     * @param \StructType\DateRangeType $updateDateRange
     */
    public function __construct(\StructType\DateRangeType $eventDateRange = null, \StructType\DateRangeType $updateDateRange = null)
    {
        $this
     ...
     * @param \StructType\DateRangeType $eventDateRange
     * @return \StructType\EventHistoryRequestType
     */
    public function setEventDateRange(\StructType\DateRangeType $eventDateRange = null)
    {
