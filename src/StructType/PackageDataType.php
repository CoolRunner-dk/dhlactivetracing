...
class PackageDataType extends AbstractStructBase
{
     ...
     * @param \DHLTracking\StructType\EventHistoryType $packageHistory
     */
    public function __construct($packageId = null, \DHLTracking\StructType\EventHistoryType $packageHistory = null)
    {
        $this
     ...
     * Set packageId value
     * @param string $packageId
     * @return \DHLTracking\StructType\PackageDataType
     */
     ...
     * @return \DHLTracking\StructType\PackageDataType
     */
    public function setPackageHistory(\DHLTracking\StructType\EventHistoryType $packageHistory = null)
    {
