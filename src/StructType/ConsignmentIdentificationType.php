...
class ConsignmentIdentificationType extends AbstractStructBase
{
     ...
     * @uses \DHLTracking\EnumType\IdentificationType::valueIsValid()
     * @uses \DHLTracking\EnumType\IdentificationType::getValidValues()
    ...
    public function setIdentificationType($identificationType = null)
    {
        ...
        if (!\DHLTracking\EnumType\IdentificationType::valueIsValid($identificationType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $identificationType, implode(', ', \DHLTracking\EnumType\IdentificationType::getValidValues())), __LINE__);
        }
